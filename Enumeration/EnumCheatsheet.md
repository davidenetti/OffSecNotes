...
|**Command**|**Description**|
|-|-|
| `mysql -u <user> -h <FQDN/IP> -p` | Login to the MySQL server. |
...
| `use auxiliary/scanner/mssql/mssql_ping` | Footprinting with Metasploit (see also other modules directly from Metasploit)
